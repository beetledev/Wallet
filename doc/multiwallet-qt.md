...
In order to support loading of multiple wallets in beetlecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is beetlecoin.cpp.
...
Changes to beetlecoin.cpp
----------------------
beetlecoin.cpp is the entry point into beetlecoin-qt, and as such, will require some minor modifications to provide hooks for
