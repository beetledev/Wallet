...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BeetleCoin Core beetlecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  beetlecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beetlecoin transaction") + "\n" +
                               "  beetlecoin-tx [options] -create [commands]   " + _("Create hex-encoded beetlecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded beetlecoin transaction
