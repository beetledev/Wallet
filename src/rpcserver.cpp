...
#ifdef ENABLE_WALLET
        {"beetlecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use beetlecoind, or the -server option to beetlecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
