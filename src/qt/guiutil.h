...
/** Utility functions used by the BeetleCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BeetleCoin addresses in monospace font
...
// Parse "beetlecoin:" URI into recipient object, return true on successful parsing
