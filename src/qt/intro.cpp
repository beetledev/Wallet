...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BeetleCoin Core"),
     ...
     * override -datadir in the beetlecoin.conf file in the default data directory
     * (to be consistent with beetlecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
