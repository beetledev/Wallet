...
{
    ZBeetleCoinControlDialog* zBEETControl = new ZBeetleCoinControlDialog(this);
...
void PrivacyDialog::sendzBEET()
{
    ...
    if (!ZBeetleCoinControlDialog::listSelectedMints.empty()) {
        vMintsSelected = ZBeetleCoinControlDialog::GetSelectedMints();
    }
    ...
    // Clear zbeetlecoin selector in case it was used
    ZBeetleCoinControlDialog::listSelectedMints.clear();
