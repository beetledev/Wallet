...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 BEETLECOIN at the same time
...
enum ZerocoinSpendStatus {
    ZBEETLECOIN_SPEND_OKAY = 0,                            // No error
    ZBEETLECOIN_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZBEETLECOIN_WALLET_LOCKED = 2,                         // Wallet was locked
    ZBEETLECOIN_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZBEETLECOIN_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZBEETLECOIN_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZBEETLECOIN_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZBEETLECOIN_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZBEETLECOIN_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZBEETLECOIN_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZBEETLECOIN_INVALID_COIN = 10,                         // Selected mint coin is not valid
