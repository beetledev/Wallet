Contributing to BeetleCoin Core
============================

The BeetleCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BeetleCoin Core project, and is not to be
confused with overall BeetleCoin Network Protocol consensus changes.

Whether a pull request is merged into BeetleCoin Core rests with the project merge
...
Patches that change BeetleCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BeetleCoin consensus, it must have been
...
The project leader is the release manager for each BeetleCoin Core release.
